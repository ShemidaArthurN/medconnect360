...
Medconnect360 is a MERN stack application that allows you to book appointments with specialists. This app facilitates to create doctors of various clinic.
...
User may able to create login and book the appointments with the doctors.
...
User has the opportunity to modify the details by pressing the Edit button.
...
<pre>
git clone https://github.com/ShemidaArthurN/medconnect360
cd ./medconnect360
</pre>
...
This app is deployed on Heroku. To deploy the app, you will need to build a production version of the app as well as have Heroku CLI installed.
